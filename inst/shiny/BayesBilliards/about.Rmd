...
* **Adjust number of samples per iteration** - This will provide a slider input to adjust the number size of the simulated random samples for each iteration.
* **Number of Samples** - The length of the prior distributions. For the first iteration, *k* random numbers are drawn from the uniform distribution. For subsequent iterations, *k* random numbers are drawn the posterior distribution of the previous iteration, with replacement so to have a prior of length *k* with the same shape.
